    ...
    <div className="min-h-screen bg-white text-black font-['Inter',sans-serif]">
      <nav className="border-b border-gray-200 py-6 sticky top-0 bg-white/95 backdrop-blur-xl z-20">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            ESCUTA AÍ <span className="font-light text-gray-500">/ music auto matcher!</span>
          </h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        {loading && (
          <div className="text-center py-32 font-black text-sm tracking-[0.3em] animate-pulse text-gray-400">
            CARREGANDO...
          </div>
        )}
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            ...
            {searchResults.map((t, i) => (
              <div
                ...
                className="group flex justify-between items-center p-8 bg-gray-800 text-white border border-gray-700 hover:bg-gray-900 hover:border-gray-600 cursor-pointer transition-all"
              >
                <div>
          ...
          <div className="animate-in fade-in duration-1000">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
              {recommendations.map((track, i) => (
                <div
                  key={i}
                  className="group bg-gray-800 text-white border border-gray-700 p-8 hover:bg-gray-900 hover:border-gray-600 hover:shadow-xl transition-all"
                >
        ...
        {!loading && !selectedTrack && searchResults.length === 0 && (
          <div className="text-center py-40">
            <h2 className="text-8xl font-black tracking-tighter">MERGULHA NO SOM</h2>
          </div>
        )}
      </main>
    </div>
